...
int main(int argc, char* argv[])
{
  ...
  h.onMessage([&ukf,&tools,&estimations,&ground_truth,&outfile](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length, uWS::OpCode opCode) { //reference pass
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2')
    {
      ...
      if (s != "") {
        ...
        if (outfile.is_open()){
          ...
          outfile << fixed << setprecision(4) << nis << ", ";
